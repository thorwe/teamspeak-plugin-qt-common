...
void Print(const QString &message, uint64 serverConnectionHandlerID = 0, LogLevel logLevel = LogLevel_INFO);
inline void Print(const QString &message, LogLevel logLevel)
{
    Print(message, 0, logLevel);
}

void Log(const QString &message, uint64 serverConnectionHandlerID = 0, LogLevel logLevel = LogLevel_INFO);
inline void Log(const QString &message, LogLevel logLevel)
{
    Log(message, 0, logLevel);
}
